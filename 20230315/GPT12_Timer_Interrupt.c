...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define ISR_PRIORITY_GPT12_TIMER_T3    11                       /* Define the GPT12 Timer3 interrupt priority            */
#define ISR_PRIORITY_GPT12_TIMER_T2    10                       /* Define the GPT12 Timer2 interrupt priority            */
#define ISR_PROVIDER_GPT12_TIMER       IfxSrc_Tos_cpu0         /* Interrupt provider                                   */
#define RELOAD_VALUE                   48828u
...
#define TEST_PIN1                      &MODULE_P00, 7          /* LED which toggles in the Interrupt Service Routine   */
#define TEST_PIN3                      &MODULE_P00, 9          /* LED which toggles in the Interrupt Service Routine   */
#define WAIT_TIME                      1
...
void initGpt12Timer(void)
{
    ...
    IfxGpt12_T3_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_50ms);                   /* Set T3 start value           */
    ...
    IfxGpt12_T2_run(&MODULE_GPT120, IfxGpt12_TimerRun_start);                       /* Start the timer T2             */
}
