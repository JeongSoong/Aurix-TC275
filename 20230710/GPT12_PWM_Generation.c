...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define ISR_PRIORITY_GPT12_TIMER    30                       /* Define the GPT12 Timer interrupt priority            */
...
#define MAX_VAL_16_BIT              250

float32 fTimer=0;
uint16 dutyUpTime=0;
uint16 dutyDownTime=0;
uint32  g_cntOverflow = 0;
uint32  g_previousCntVal1= 0;
...
uint32 GPT12_T2_Int0_Handler(void)
{
    ...
    else
    {
         ...
         */
        finalCntVal = (uint32)(currentCntVal + (MAX_VAL_16_BIT - g_previousCntVal1) + ((g_cntOverflow - 1) * MAX_VAL_16_BIT));
    }
