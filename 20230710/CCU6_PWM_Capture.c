...
#define L298_IN1  &MODULE_P02,3 //0.9
#define L298_IN2  &MODULE_P02,4  //0.10
...
float32 g_generatedPwmFreq_Hz = 50.0;        /* Frequency of the generated PWM signal                                */
float32 g_generatedPwmDutyCycle = 10.0;     /* Duty cycle in percentage of the generated PWM signal                 */
...
{
    motor_pwm = generate_PWM_signal(input_pwm);
    if(motor_pwm<0.0)
    {
