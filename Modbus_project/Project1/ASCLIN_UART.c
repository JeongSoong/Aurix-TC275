...
uint8 uart_rx_buff[8] = {0, };
uint8 g_rxRcvBuffer[MAX_RCV_BUFFUR_SIZE] = {''};
...
void send_data(void)
{
    ...
    protocal_test[1] = 184;
    protocal_test[2] = 'i';
    protocal_test[3] = 0x01;
    protocal_test[4] = 0x0f;
...
void send_receive_UART_message(void)
{
    IfxAsclin_Asc_read(&g_ascHandle, g_txData, &g_count, TIME_INFINITE);
}

void send_ASCLIN_UART_message(void)
{
    send_data();
    IfxAsclin_Asc_write(&g_ascHandle, protocal_test, &p_count, TIME_INFINITE);
}
